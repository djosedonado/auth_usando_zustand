...
class SnowflakeDialect extends import_abstract.AbstractDialect {
  ...
  constructor(sequelize) {
    ...
    this.connectionManager = new import_connection_manager.SnowflakeConnectionManager(this);
    this.queryGenerator = new import_query_generator.SnowflakeQueryGenerator(this);
    this.queryInterface = new import_query_interface.SnowflakeQueryInterface(this);
  }
  createBindCollector() {
