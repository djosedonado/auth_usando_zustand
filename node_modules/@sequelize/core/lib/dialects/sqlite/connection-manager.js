...
var import_node = require("@sequelize/utils/node.js");
...
class SqliteConnectionManager extends import_connection_manager.AbstractConnectionManager {
  ...
  async _onProcessExit() {
    await Promise.all(
      (0, import_utils.map)(this.connections.values(), async (connection) => {
  ...
  async getConnection(options) {
    ...
    if (!inMemory && (readWriteMode & this.lib.OPEN_CREATE) !== 0 && !await (0, import_node.checkFileExists)(storageDir)) {
